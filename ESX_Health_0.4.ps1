...
Function Get-ESX_SAN { Param( [Parameter(Position = 0, ValueFromPipeline=$True, Mandatory=$True)] [String]$vmHost )
	...
	$ArraySAN_HBATarget 				= @()	# Initialisation du tableau relatif au nombre de cibles SAN
	...
	ForEach($hba in (Get-VMHostHba -VMHost $ESX.Name -Type "FibreChannel")) {
		...
		$ArraySAN_Line = (1..$Target.Count)
		ForEach($l in $ArraySAN_Line)	{
			$ArraySAN_HBAName	+= $hba.Name
            $ArraySAN_HBATarget += $Target.Count
	...
	$ExcelWorkSheet.Cells.Item($no_inc_ESX + 1, $Excel_SAN_Total_Chemins) 			= "$PathsSum" + " (" + $Target.Count + " HBA)"		# Ligne, Colonne
	$ExcelWorkSheet.Cells.Item($no_inc_ESX + 1, $Excel_SAN_Total_LUNs)				= "$LUNsSum" + " (" + $Target.Count + " HBA)"		# Ligne, Colonne
...
Function Get-ESX_Compare_Full {
	...
	$ExcelWorkSheet_Ref.Cells.Item($Cluster_ID + 1, $Excel_Ref_ArrayVersion)	= $Ref_ArrayVersion
	$ExcelWorkSheet_Ref.Cells.Item($Cluster_ID + 1, $Excel_Ref_ArrayTimeZone) 	= $Ref_ArrayTimeZone
	$ExcelWorkSheet_Ref.Cells.Item($Cluster_ID + 1, $Excel_Ref_ArrayBaseline) 	= $Ref_ArrayBaseline
	$ExcelWorkSheet_Ref.Cells.Item($Cluster_ID + 1, $Excel_Ref_ArrayNTPd) 		= $Ref_ArrayNTPd
	$ExcelWorkSheet_Ref.Cells.Item($Cluster_ID + 1, $Excel_Ref_ArraySAN) 		= $Ref_ArraySAN
	$ExcelWorkSheet_Ref.Cells.Item($Cluster_ID + 1, $Excel_Ref_ArrayLUN) 		= $Ref_ArrayLUN
	$ExcelWorkSheet_Ref.Cells.Item($Cluster_ID + 1, $Excel_Ref_ArrayCPUPolicy) 	= $Ref_ArrayCPUPolicy
	$ExcelWorkSheet_Ref.Cells.Item($Cluster_ID + 1, $Excel_Ref_ArrayHA) 		= $Ref_ArrayHA
	$ExcelWorkSheet_Ref.Cells.Item($Cluster_ID + 1, $Excel_Ref_ArrayHyperTh) 	= $Ref_ArrayHyperTh
	$ExcelWorkSheet_Ref.Cells.Item($Cluster_ID + 1, $Excel_Ref_ArrayEVC) 		= $Ref_ArrayEVC
	$ExcelWorkSheet_Ref.Cells.Item($Cluster_ID + 1, $Excel_Ref_ArrayAlarme) 	= $Ref_ArrayAlarme
	$ExcelWorkSheet_Ref.Cells.Item($Cluster_ID + 1, $Excel_Ref_ArrayTPS) 		= $Ref_ArrayTPS
	$ExcelWorkSheet_Ref.Cells.Item($Cluster_ID + 1, $Excel_Ref_ArrayLPages) 	= $Ref_ArrayLPages
	$ExcelWorkSheet_Ref.Cells.Item($Cluster_ID + 1, $Excel_Ref_ArrayVLAN) 		= $Ref_ArrayVLAN
	$ExcelWorkSheet_Ref.Cells.Item($Cluster_ID + 1, $Excel_Ref_ArrayLAN) 		= $Ref_ArrayLAN
	...
	ForEach($l in $ExcelLine)	{
		...
		If ($ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Statut_ESX).Text -ne "PoweredOff") {
			If ($ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Etat_ESX).Text -eq "Connected") {
				If ($ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Balise).Text -Like "@*") {
					If ($ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Serveurs_NTP).Font.ColorIndex -eq $Excel_Couleur_Error)	{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[Erreur NTP Serveur]"; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 }
					If ($ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Balise).Text -ne $Ref_ArrayTag) 							{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ Tag/Ensemble]"; 				$ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Balise).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Balise).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 }								Else { $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Balise).Font.ColorIndex = 1; 				$ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Balise).Font.Bold = $False }
					If ($ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Version).Text -ne $Ref_ArrayVersion) 					{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ Version/Ensemble]"; 			$ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Version).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Version).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 }							Else { $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Version).Font.ColorIndex = 1; 			$ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Version).Font.Bold = $False }
					If ($ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Zone_Temps).Text -ne $Ref_ArrayTimeZone) 				{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ TimeZone/Ensemble]"; 		$ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Zone_Temps).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Zone_Temps).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 }						Else { $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Zone_Temps).Font.ColorIndex = 1; 			$ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Zone_Temps).Font.Bold = $False }
					If ($ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Niveau_Compliance).Text -ne $Ref_ArrayBaseline) 			{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ Baseline/Ensemble]"; 		$ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Niveau_Compliance).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Niveau_Compliance).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 }		Else { $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Niveau_Compliance).Font.ColorIndex = 1; 	$ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Niveau_Compliance).Font.Bold = $False }
					If ($ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Etat_Demon_NTP).Text -ne $Ref_ArrayNTPd) 				{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ NTP démon/Ensemble]"; 		$ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Etat_Demon_NTP).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Etat_Demon_NTP).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 }				Else { $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Etat_Demon_NTP).Font.ColorIndex = 1; 		$ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Etat_Demon_NTP).Font.Bold = $False }
					If ($ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_Chemins).Text.Substring(0, $ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_Chemins).Text.IndexOf(" ")) -ne $Ref_ArraySAN) { $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= 					$ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ Chemins SAN/Ensemble]"; $ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_Chemins).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_Chemins).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 } Else { $ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_Chemins).Font.ColorIndex = 1; $ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_Chemins).Font.Bold = $False }
					...
					If ($ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_Chemins_MORTS).Text.Substring(0, $ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_Chemins_MORTS).Text.IndexOf("(") - 1) -ne $Ref_ArraySANDeath) { $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details) =$ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[Chemin(s) mort(s)]"; $ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_Chemins_MORTS).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_Chemins_MORTS).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 } Else { $ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_Chemins_MORTS).Font.ColorIndex = 1; $ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_Chemins_MORTS).Font.Bold = $False }
					If ($ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_Chemins_ACTIFS).Text.Substring(0, $ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_Chemins_ACTIFS).Text.IndexOf("(") - 1) -ne $Ref_ArraySANAlive) { $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details) =$ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[Chemin(s) présent(s)]"; $ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_Chemins_ACTIFS).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_Chemins_ACTIFS).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 } Else { $ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_Chemins_ACTIFS).Font.ColorIndex = 1; $ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_Chemins_ACTIFS).Font.Bold = $False }
					If ($ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Redondance_Chemins).Text -ne $Ref_ArraySANRedon) 			{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[Erreur redondance SAN]"; 		$ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Redondance_Chemins).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Redondance_Chemins).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 }		Else { $ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Redondance_Chemins).Font.ColorIndex = 1; 	$ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Redondance_Chemins).Font.Bold = $False }
					If ($ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Current_CPU_Policy).Text -ne $Ref_ArrayCPUPolicy)		{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠CPU Policy/Ensemble]"; 		$ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Current_CPU_Policy).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Current_CPU_Policy).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 }		Else { $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Current_CPU_Policy).Font.ColorIndex = 1; 	$ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Current_CPU_Policy).Font.Bold = $False }
					If ($ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Mode_HA).Text -ne $Ref_ArrayHA) 							{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ HA/Ensemble]"; 				$ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Mode_HA).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Mode_HA).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 }							Else { $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Mode_HA).Font.ColorIndex = 1; 			$ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Mode_HA).Font.Bold = $False }
					If ($ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Hyperthreading).Text -ne $Ref_ArrayHyperTh) 				{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ HyperThreading/Ensemble]"; 	$ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Hyperthreading).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Hyperthreading).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 }				Else { $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Hyperthreading).Font.ColorIndex = 1; 		$ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Hyperthreading).Font.Bold = $False }
					If ($ExcelWorkSheet.Cells.Item($l, $Excel_HOST_EVC).Text -ne $Ref_ArrayEVC) 							{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ EVC/Ensemble]"; 				$ExcelWorkSheet.Cells.Item($l, $Excel_HOST_EVC).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_EVC).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 } 									Else { $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_EVC).Font.ColorIndex = 1; 				$ExcelWorkSheet.Cells.Item($l, $Excel_HOST_EVC).Font.Bold = $False }
					If ($ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Etat_Alarmes).Text -ne $Ref_ArrayAlarme)					{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ Alarmes/Ensemble]"; 			$ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Etat_Alarmes).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Etat_Alarmes).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 }					Else { $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Etat_Alarmes).Font.ColorIndex = 1; 		$ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Etat_Alarmes).Font.Bold = $False }
					If ($ExcelWorkSheet.Cells.Item($l, $Excel_HOST_TPS_Salting).Text -ne $Ref_ArrayTPS) 					{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ TPS/Ensemble]"; 				$ExcelWorkSheet.Cells.Item($l, $Excel_HOST_TPS_Salting).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_TPS_Salting).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 }					Else { $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_TPS_Salting).Font.ColorIndex = 1; 		$ExcelWorkSheet.Cells.Item($l, $Excel_HOST_TPS_Salting).Font.Bold = $False }
					If ($ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Larges_Pages_RAM).Text -ne $Ref_ArrayLPages) 			{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ Large Pages/Ensemble]"; 		$ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Larges_Pages_RAM).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Larges_Pages_RAM).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 }			Else { $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Larges_Pages_RAM).Font.ColorIndex = 1; 	$ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Larges_Pages_RAM).Font.Bold = $False }
					If ($ExcelWorkSheet.Cells.Item($l, $Excel_NETWORK_VLAN).Text.Substring(1, $ExcelWorkSheet.Cells.Item($l, $Excel_NETWORK_VLAN).Text.IndexOf(")") - 1) -ne $Ref_ArrayVLAN) { $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= 						$ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ VLANs/Ensemble]"; $ExcelWorkSheet.Cells.Item($l, $Excel_NETWORK_VLAN).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_NETWORK_VLAN).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 } Else { $ExcelWorkSheet.Cells.Item($l, $Excel_NETWORK_VLAN).Font.ColorIndex = 1; $ExcelWorkSheet.Cells.Item($l, $Excel_NETWORK_VLAN).Font.Bold = $False }
					If ($ExcelWorkSheet.Cells.Item($l, $Excel_NETWORK_Adaptateurs).Text.Substring(1, $ExcelWorkSheet.Cells.Item($l, $Excel_NETWORK_Adaptateurs).Text.IndexOf(")") - 1) -ne $Ref_ArrayLAN) { $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= 			$ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ Adaptateurs LAN/Ensemble]"; $ExcelWorkSheet.Cells.Item($l, $Excel_NETWORK_Adaptateurs).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_NETWORK_Adaptateurs).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 } Else { $ExcelWorkSheet.Cells.Item($l, $Excel_NETWORK_Adaptateurs).Font.ColorIndex = 1; $ExcelWorkSheet.Cells.Item($l, $Excel_NETWORK_Adaptateurs).Font.Bold = $False }
		...
		$ExcelWorkSheet.Cells.Item($l, $Excel_TimeStamp) = Get-Date -UFormat "%Y_%m_%d_%H_%M_%S"
	}
...
Function Get-ESX_Compare_CiblesvsReference {
	...
	If (!(GetName.Row)) {
		...
		If (($ESX_Inc -eq "TOUS") -and ($ESX_Exc -eq "AUCUN")) { Get-Ajout_Nouveau_Cluster }
		Else {
	...
	Else {
		...
		ForEach($l in $ExcelLine)	{
			...
			If ($GetName.Row -and $ExcelWorkSheet.Cells.Item($GetName.Row, $Excel_CONF_Statut_ESX).Text -ne "PoweredOff") {
				If ($ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Serveurs_NTP).Font.ColorIndex -eq $Excel_Couleur_Error)	{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[Erreur NTP Serveur]"; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 }
				If ($ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Version).Text -ne $Ref_ArrayVersion) 					{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ Version/Référence]"; $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Version).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Version).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 }							Else { $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Version).Font.ColorIndex = 1; $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Version).Font.Bold = $False }
				If ($ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Zone_Temps).Text -ne $Ref_ArrayTimeZone)					{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ TimeZone/Référence]"; $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Zone_Temps).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Zone_Temps).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 }						Else { $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Zone_Temps).Font.ColorIndex = 1; $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Zone_Temps).Font.Bold = $False }
				If ($ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Niveau_Compliance).Text -ne $Ref_ArrayBaseline) 			{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ Baseline/Référence]"; $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Niveau_Compliance).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Niveau_Compliance).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 }		Else { $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Niveau_Compliance).Font.ColorIndex = 1; $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Niveau_Compliance).Font.Bold = $False }
				If ($ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Etat_Demon_NTP).Text -ne $Ref_ArrayNTPd) 				{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ NTP démon/Référence]"; $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Etat_Demon_NTP).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Etat_Demon_NTP).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 }			Else { $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Etat_Demon_NTP).Font.ColorIndex = 1; $ExcelWorkSheet.Cells.Item($l, $Excel_CONF_Etat_Demon_NTP).Font.Bold = $False }
				If ($ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_Chemins).Text.Substring(0, $ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_Chemins).Text.IndexOf(" ")) -ne $Ref_ArraySAN)		{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ Chemins SAN/Référence]"; 	$ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_Chemins).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_Chemins).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 }	Else { $ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_Chemins).Font.ColorIndex = 1; $ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_Chemins).Font.Bold = $False }
				If ($ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_LUNs).Text -ne $Ref_ArrayLUN)						{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ LUNs/Référence]"; 	$ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_LUNs).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_LUNs).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 }						Else { $ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_LUNs).Font.ColorIndex = 1; $ExcelWorkSheet.Cells.Item($l, $Excel_SAN_Total_LUNs).Font.Bold = $False }
				If ($ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Current_CPU_Policy).Text -ne $Ref_ArrayCPUPolicy)		{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ CPU Policy/Référence]"; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Current_CPU_Policy).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Current_CPU_Policy).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1}	Else { $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Current_CPU_Policy).Font.ColorIndex = 1; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Current_CPU_Policy).Font.Bold = $False }
				If ($ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Mode_HA).Text -ne $Ref_ArrayHA) 							{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ HA/Référence]"; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Mode_HA).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Mode_HA).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 } 								Else { $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Mode_HA).Font.ColorIndex = 1; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Mode_HA).Font.Bold = $False }
				If ($ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Hyperthreading).Text -ne $Ref_ArrayHyperTh) 				{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ HyperThreading/Référence]";$ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Hyperthreading).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Hyperthreading).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 }		Else { $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Hyperthreading).Font.ColorIndex = 1; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Hyperthreading).Font.Bold = $False }
				If ($ExcelWorkSheet.Cells.Item($l, $Excel_HOST_EVC).Text -ne $Ref_ArrayEVC) 							{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ EVC/Référence]"; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_EVC).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_EVC).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 } 										Else { $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_EVC).Font.ColorIndex = 1; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_EVC).Font.Bold = $False }
				If ($ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Etat_Alarmes).Text -ne $Ref_ArrayAlarme)					{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ Alarmes/Référence]"; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Etat_Alarmes).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Etat_Alarmes).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 }					Else { $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Etat_Alarmes).Font.ColorIndex = 1; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Etat_Alarmes).Font.Bold = $False }
				If ($ExcelWorkSheet.Cells.Item($l, $Excel_HOST_TPS_Salting).Text -ne $Ref_ArrayTPS) 					{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ TPS/Référence]"; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_TPS_Salting).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_TPS_Salting).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 }						Else { $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_TPS_Salting).Font.ColorIndex = 1; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_TPS_Salting).Font.Bold = $False }
				If ($ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Larges_Pages_RAM).Text -ne $Ref_ArrayLPages) 			{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ Large Pages/Référence]"; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Larges_Pages_RAM).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Larges_Pages_RAM).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1}		Else { $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Larges_Pages_RAM).Font.ColorIndex = 1; $ExcelWorkSheet.Cells.Item($l, $Excel_HOST_Larges_Pages_RAM).Font.Bold = $False }
				If ($ExcelWorkSheet.Cells.Item($l, $Excel_NETWORK_VLAN).Text.Substring(1, $ExcelWorkSheet.Cells.Item($l, $Excel_NETWORK_VLAN).Text.IndexOf(")") - 1) -ne $Ref_ArrayVLAN) 	{ $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details)	= $ExcelWorkSheet.Cells.Item($l, $Excel_Conformite_Details).Text + "[≠ VLAN/Référence]"; 			$ExcelWorkSheet.Cells.Item($l, $Excel_NETWORK_VLAN).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet.Cells.Item($l, $Excel_NETWORK_VLAN).Font.Bold = $True; $ESX_NotCompliant_Item += 1; $ESX_Percent_NotCompliant += 1 }	Else { $ExcelWorkSheet.Cells.Item($l, $Excel_NETWORK_VLAN).Font.ColorIndex = 1; $ExcelWorkSheet.Cells.Item($l, $Excel_NETWORK_VLAN).Font.Bold = $False }
...
Function Get-Ajout_Nouveau_Cluster {
	Write-Host "Ajout du nouveau cluster dans les références... " -NoNewLine
	Write-Host "En cours" -ForegroundColor Green
	LogTrace ("Ajout du nouveau cluster dans les références...")
	...
	If ($GetName.Row) {
		...
		$ExcelWorkSheet_Ref.Cells.Item($GetName.Row, $Excel_Ref_ArrayVersion)	= $Ref_ArrayVersion
		$ExcelWorkSheet_Ref.Cells.Item($GetName.Row, $Excel_Ref_ArrayTimeZone) 	= $Ref_ArrayTimeZone
		$ExcelWorkSheet_Ref.Cells.Item($GetName.Row, $Excel_Ref_ArrayBaseline) 	= $Ref_ArrayBaseline
		$ExcelWorkSheet_Ref.Cells.Item($GetName.Row, $Excel_Ref_ArrayNTPd) 		= $Ref_ArrayNTPd
		$ExcelWorkSheet_Ref.Cells.Item($GetName.Row, $Excel_Ref_ArraySAN) 		= $Ref_ArraySAN
		$ExcelWorkSheet_Ref.Cells.Item($GetName.Row, $Excel_Ref_ArrayLUN) 		= $Ref_ArrayLUN
		$ExcelWorkSheet_Ref.Cells.Item($GetName.Row, $Excel_Ref_ArrayCPUPolicy) = $Ref_ArrayCPUPolicy
		$ExcelWorkSheet_Ref.Cells.Item($GetName.Row, $Excel_Ref_ArrayHA) 		= $Ref_ArrayHA
		$ExcelWorkSheet_Ref.Cells.Item($GetName.Row, $Excel_Ref_ArrayHyperTh)	= $Ref_ArrayHyperTh
		$ExcelWorkSheet_Ref.Cells.Item($GetName.Row, $Excel_Ref_ArrayEVC) 		= $Ref_ArrayEVC
		$ExcelWorkSheet_Ref.Cells.Item($GetName.Row, $Excel_Ref_ArrayAlarme) 	= $Ref_ArrayAlarme
		$ExcelWorkSheet_Ref.Cells.Item($GetName.Row, $Excel_Ref_ArrayTPS) 		= $Ref_ArrayTPS
		$ExcelWorkSheet_Ref.Cells.Item($GetName.Row, $Excel_Ref_ArrayLPages) 	= $Ref_ArrayLPages
		$ExcelWorkSheet_Ref.Cells.Item($GetName.Row, $Excel_Ref_ArrayVLAN) 		= $Ref_ArrayVLAN
		$ExcelWorkSheet_Ref.Cells.Item($GetName.Row, $Excel_Ref_ArrayLAN) 		= $Ref_ArrayLAN
	}
	...
	### Mise à jour de la colonne TimeStamp
	$ExcelWorkSheet_Ref.Cells.Item($GetName.Row, $Excel_Ref_TimeStamp) = Get-Date -UFormat "%Y_%m_%d_%H_%M_%S"
...
Function Get-Cluster_Compare {
	...
	ForEach($l in $ExcelLine)	{
		...
		If ($ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayVersion).Text -ne $Ref_ArrayVersion) 	{ $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_Conformite_Details)	= $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_Conformite_Details).Text + "[≠ Version/Ensemble]"; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayVersion).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayVersion).Font.Bold = $True; $Cluster_NotCompliant_Item += 1 } 		Else { $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayVersion).Font.ColorIndex = 1; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayVersion).Font.Bold = $False }
		If ($ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayTimeZone).Text -ne $Ref_ArrayTimeZone) 	{ $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_Conformite_Details)	= $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_Conformite_Details).Text + "[≠ TimeZone/Ensemble]"; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayTimeZone).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayTimeZone).Font.Bold = $True; $Cluster_NotCompliant_Item += 1 } 		Else { $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayTimeZone).Font.ColorIndex = 1; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayTimeZone).Font.Bold = $False }
		If ($ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayBaseline).Text -ne $Ref_ArrayBaseline) 	{ $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_Conformite_Details)	= $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_Conformite_Details).Text + "[≠ Baseline/Ensemble]"; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayBaseline).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayBaseline).Font.Bold = $True; $Cluster_NotCompliant_Item += 1 } 		Else { $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayBaseline).Font.ColorIndex = 1; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayBaseline).Font.Bold = $False }
		If ($ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayNTPd).Text -ne $Ref_ArrayNTPd) 			{ $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_Conformite_Details)	= $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_Conformite_Details).Text + "[≠ NTP démon/Ensemble]"; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayNTPd).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayNTPd).Font.Bold = $True; $Cluster_NotCompliant_Item += 1 } 			Else { $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayNTPd).Font.ColorIndex = 1; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayNTPd).Font.Bold = $False }
		If ($ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayCPUPolicy).Text -ne $Ref_ArrayCPUPolicy) { $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_Conformite_Details)	= $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_Conformite_Details).Text + "[≠ CPU Policy/Ensemble]"; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayCPUPolicy).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayCPUPolicy).Font.Bold = $True; $Cluster_NotCompliant_Item += 1 }	Else { $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayCPUPolicy).Font.ColorIndex = 1; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayCPUPolicy).Font.Bold = $False }
		If ($ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayHA).Text -ne $Ref_ArrayHA) 				{ $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_Conformite_Details)	= $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_Conformite_Details).Text + "[≠ HA/Ensemble]"; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayHA).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayHA).Font.Bold = $True; $Cluster_NotCompliant_Item += 1 } 						Else { $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayHA).Font.ColorIndex = 1; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayHA).Font.Bold = $False }
		If ($ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayHyperTh).Text -ne $Ref_ArrayHyperTh) 	{ $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_Conformite_Details)	= $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_Conformite_Details).Text + "[≠ HyperThreading/Ensemble]"; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayHyperTh).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayHyperTh).Font.Bold = $True; $Cluster_NotCompliant_Item += 1 } 	Else { $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayHyperTh).Font.ColorIndex = 1; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayHyperTh).Font.Bold = $False }
		If ($ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayEVC).Text -ne $Ref_ArrayEVC) 			{ $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_Conformite_Details)	= $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_Conformite_Details).Text + "[≠ EVC/Ensemble]"; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayEVC).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayEVC).Font.Bold = $True; $Cluster_NotCompliant_Item += 1 } 					Else { $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayEVC).Font.ColorIndex = 1; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayEVC).Font.Bold = $False }
		If ($ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayAlarme).Text -ne $Ref_ArrayAlarme)		{ $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_Conformite_Details)	= $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_Conformite_Details).Text + "[≠ Alarmes/Ensemble]"; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayAlarme).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayAlarme).Font.Bold = $True; $Cluster_NotCompliant_Item += 1 } 			Else { $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayAlarme).Font.ColorIndex = 1; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayAlarme).Font.Bold = $False }
		If ($ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayTPS).Text -ne $Ref_ArrayTPS) 			{ $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_Conformite_Details)	= $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_Conformite_Details).Text + "[≠ TPS/Ensemble]"; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayTPS).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayTPS).Font.Bold = $True; $Cluster_NotCompliant_Item += 1 } 					Else { $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayTPS).Font.ColorIndex = 1; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayTPS).Font.Bold = $False }
		If ($ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayLPages).Text -ne $Ref_ArrayLPages) 		{ $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_Conformite_Details)	= $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_Conformite_Details).Text + "[≠ Large Pages/Ensemble]"; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayLPages).Font.ColorIndex = $Excel_Couleur_Error; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayLPages).Font.Bold = $True; $Cluster_NotCompliant_Item += 1 } 		Else { $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayLPages).Font.ColorIndex = 1; $ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_ArrayLPages).Font.Bold = $False }
	
		### Mise à jour de la colonne TimeStamp
		$ExcelWorkSheet_Ref.Cells.Item($l, $Excel_Ref_TimeStamp) = Get-Date -UFormat "%Y_%m_%d_%H_%M_%S"
	}
...
If ($args[1]) {
	...
	If (Test-Path ($RepLog + $ScriptName + "_REF.xlsx")) {
		Write-Host "INFO: Le fichier Excel de référence '$($RepLog + $ScriptName + "_REF.xlsx")' est disponible. Comparaison possible..." -ForegroundColor Green
		LogTrace ("INFO: Le fichier Excel de référence '$($RepLog + $ScriptName + "_REF.xlsx")' est disponible. Comparaison possible...")
		...
		Write-Host "INFO: Le fichier Excel de référence '$RepLog + $ScriptName + "_REF.xlsx"' est indisponible. Comparaison impossible..." -ForegroundColor Red
		LogTrace ("INFO: Le fichier Excel de référence '$($RepLog + $ScriptName + "_REF.xlsx")' est indisponible. Comparaison impossible...") }
	...
	If (Test-Path ($RepLog + $ScriptName + "_REF.xlsx")) {
		...
		Else	{
			...
			Exit }
	} Else { Copy-Item ($PathScript + "ESX_Health_Modele.xlsx") -Destination ($RepLog + $ScriptName + "_REF.xlsx") }			# Copie du modèle pour modification par le script
...
ForEach ($vCenter in $TabVcc) {
	...
	ForEach($DC in $oDatacenters){ $noDatacenter += 1
		...
		ForEach($Cluster in Get-Cluster -Location $DC | Sort Name)	{
			...
			LogTrace ($vbcrlf + "Traitement CLUSTER '$Cluster' n°$noCluster sur $Cluster_Counter {$Cluster_ID}")
			...
			ForEach($ESX in Get-vmHost -Location $Cluster) {
				...
				If ($ESX.PowerState -ne "PoweredOn") {
					...
					If ($Mode_Var -eq 1) { If ($no_ESX -eq $($oESX.Count)) { Get-ESX_Compare_Full; $ExcelWorkBook.Save() } }	# Dans le cas d'une découverte complète du périmètre
					If ($Mode_Var -eq 2 -And (Test-Path $($RepLog + $ScriptName + "_REF.xlsx"))) { If ($no_ESX -eq $ESX_Counter) { Get-ESX_Compare_CiblesvsReference; $ExcelWorkBook.Save(); Break } } # Dans le cas d'une vérification de conformité unitaire si le fichier Excel de référence existe
					If ($Mode_Var -eq 2 -And (Test-Path $($RepLog + $ScriptName + "_REF.xlsx"))) 	{ If ($no_ESX -eq $ESX_Counter) { Get-ESX_Compare_Cibles; $ExcelWorkBook.Save(); Break } } # Dans le cas d'une vérification de conformité unitaire si le fichier Excel de référence n'existe pas
...
$ExcelWorkBook.Save(); Write-Host "Fermeture du classeur Excel [Terminé]"; LogTrace ("Fermeture du classeur Excel [Terminé]")
